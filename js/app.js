(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-slider__swiper")) new swiper_core_Swiper(".main-slider__swiper", {
        ...
        if (document.querySelector(".mika-slider__slider")) new swiper_core_Swiper(".mika-slider__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
